...
namespace WebAppiDiscotienda.Controllers
{
    ...
    {
        private readonly Context _mybasecontext;// creamos un obejto de solo lectura de tipo basecontex que es el engardo que hacer las operaciones en la base de datos

        public DiscoController(Context context)
        {
            _mybasecontext = context;//le asignamos _mybasecontext el nuevo contexto que le pasa el parametro 
        }
